...
| [multi-worker-coherence.md](multi-worker-coherence.md) | How Baldur's scheduled jobs and runtime-config changes stay coherent as you scale from a single host to multiple workers/pods, and which settings each topology requires (state backend / EventBus / leader election, or Celery beat) | 2026-08-18 |
