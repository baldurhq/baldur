...
- **Questions & discussion** — open a thread in [GitHub Discussions](https://github.com/baldurhq/baldur/discussions).
- **Bug reports** — file a [GitHub Issue](https://github.com/baldurhq/baldur/issues) with a minimal reproduction.
- **Security vulnerabilities** — do **not** open a public issue. Follow the [Security Policy](https://github.com/baldurhq/baldur/blob/main/SECURITY.md).
...
- **Security reports** — see the [Security Policy](https://github.com/baldurhq/baldur/blob/main/SECURITY.md); PRO-impacting reports are triaged with the same priority as OSS advisories.
