...
Prometheus metrics for monitoring leader-election state.
"""
...
class LeaderElectorMetrics:
    """
    Leader Elector metrics helper.

    Encapsulates the metric updates used by LeaderElector.
    """
    ...
    def record_renew_error(self, error_type: str = "unknown") -> None:
        """Record a lease renewal failure."""
    ...
    def record_leadership_end(self) -> None:
        """Record the end of leadership (measures the held duration)."""
