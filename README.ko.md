...
Baldur는 얼리 액세스 단계입니다. 코어는 프로덕션에서 검증되었고 API도 안정적이지만
프로젝트 자체가 아직 어립니다 — 마이너 릴리스에도 호환성이 깨지는 변경이 들어갈 수
있으며, 그럴 때는 언제나 체인지로그 항목이 함께 갑니다. 지금은 이미 Python 서비스를
프로덕션에서 운영 중인 소수의 팀과 직접 협업할 상대를 찾고 있습니다. 해당되신다면
자세한 내용과 연락 방법이 [Discussions](https://github.com/baldurhq/baldur/discussions)에
있습니다.
